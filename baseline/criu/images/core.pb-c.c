...
static const ProtobufCFieldDescriptor task_core_entry__field_descriptors[17] =
{
  {
    "task_state",
    1,
  ...
  },
  {
    ...
    offsetof(TaskCoreEntry, has_child_subreaper),
    offsetof(TaskCoreEntry, child_subreaper),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT64,
    offsetof(TaskCoreEntry, has_blk_sigset_extended),
    offsetof(TaskCoreEntry, blk_sigset_extended),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned task_core_entry__field_indices_by_name[] = {
  ...
  16,   /* field[16] = blk_sigset_extended */
  8,   /* field[8] = cg_set */
  15,   /* field[15] = child_subreaper */
  5,   /* field[5] = comm */
  1,   /* field[1] = exit_code */
  3,   /* field[3] = flags */
...
static const ProtobufCIntRange task_core_entry__number_ranges[3 + 1] =
{
  { 1, 0 },
  { 18, 15 },
  { 20, 16 },
...
const ProtobufCMessageDescriptor task_core_entry__descriptor =
{
  ...
  3,  task_core_entry__number_ranges,
  (ProtobufCMessageInit) task_core_entry__init,
  NULL,NULL,NULL    /* reserved[123] */
};
static const ProtobufCFieldDescriptor task_kobj_ids_entry__field_descriptors[12] =
{
  {
    "vm_id",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    offsetof(TaskKobjIdsEntry, has_time_ns_id),
    offsetof(TaskKobjIdsEntry, time_ns_id),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor thread_core_entry__field_descriptors[14] =
{
  {
    "futex_rla",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT64,
    offsetof(ThreadCoreEntry, has_blk_sigset_extended),
    offsetof(ThreadCoreEntry, blk_sigset_extended),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned thread_core_entry__field_indices_by_name[] = {
  ...
  13,   /* field[13] = blk_sigset_extended */
  12,   /* field[12] = comm */
  9,   /* field[9] = creds */
  0,   /* field[0] = futex_rla */
...
static const ProtobufCEnumValue core_entry__march__enum_values_by_number[7] =
{
  ...
  { "MIPS", "CORE_ENTRY__MARCH__MIPS", 6 },
};
static const ProtobufCIntRange core_entry__march__value_ranges[] = {
{0, 0},{0, 7}
};
static const ProtobufCEnumValueIndex core_entry__march__enum_values_by_name[7] =
{
  { "AARCH64", 3 },
  { "ARM", 2 },
  { "MIPS", 6 },
...
static const ProtobufCFieldDescriptor core_entry__field_descriptors[10] =
{
  {
    "mtype",
    1,
