...
static int restore_one_alive_task(int pid, CoreEntry *core)
{
    ...
    prst_timing_start (TIME_OTHERS_PREP);
    ...
    prst_timing_stop (TIME_OTHERS_PREP);
    prst_display_others_timing_stats ();
    prst_reset_others_timing_stats ();
...
static int restore_task_with_children(void *_arg)
{
    ...
    prst_timing_start (TIME_MEM_PREP);
	if (prepare_mappings(current))
		goto err;
    prst_timing_stop (TIME_MEM_PREP);

	// XXX: Shiv
	// Displaying memory related stats.
	prst_display_mem_timing_stats ();
