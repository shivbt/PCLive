...
int parasite_collect_aios (struct parasite_ctl *ctl
	...
	aa = compel_parasite_args_s (ctl, PARASITE_AIO_RINGS_ARGS_REGION);
	pa = &aa->ring[0];
    ...
    // Added by Shiv
    ctl->args_offset = ((unsigned long) aa) - ((unsigned long) ctl->args);
