...
extern int prestore_started;
extern bool dump_aio_ring_flag;

#define PRESTORE_PIPE_XFER_TO_CRIU_MSG      "/tmp/prestore_pipe_xfer_to_criu_msg"
#define PRESTORE_PIPE_XFER_TO_CRIU_DATA     "/tmp/prestore_pipe_xfer_to_criu_data"
