...
extern int check_img_inventory (bool restore, bool init);
...
extern int prepare_inventory (InventoryEntry *he, bool dump_cgroup_flag);
...
extern int cr_pre_dump_tasks_general(pid_t pid);
extern int cr_restore_tasks(void);
extern int cr_pre_restore_tasks (int curr_iter, bool init_iter, bool last_iter);
extern int cr_migrate_tasks (pid_t pid);
