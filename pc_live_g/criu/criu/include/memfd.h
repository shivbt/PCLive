...
extern int memfd_open(struct vma_area *vma, struct file_desc *d, u32 *fdflags);
...
extern int memfd_inodes_init (bool is_restore);
extern int prepare_memfd_inodes (bool init_iter);
