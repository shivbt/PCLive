...
static inline int dump_sigacts_args_size (void) {
    return sizeof (struct parasite_dump_sa_args);
}
...
static inline int dump_itimers_args_size (void) {
    return sizeof (struct parasite_dump_itimers_args);
}
...
static inline int dump_misc_args_size (void) {
    return sizeof (struct parasite_dump_misc);
}
...
static inline int dump_threads_args_size (void) {
    return ((sizeof (struct parasite_dump_thread))
            + (sizeof (unsigned int) * PARASITE_MAX_GROUPS));
}
...
static inline int dump_tty_args_size (void) {
    return sizeof (struct parasite_tty_args);
}
