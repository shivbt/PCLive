...
enum {
	...
	CR_STATE_FORKING,
	/*
	 * Functions performed in this stage is more or less same as CR_STATE_RESTORE
     * but this is not the final restore, i.e. it is some of the intermediate
     * iterative restore.
	 */
	CR_STATE_PRE_RESTORE,
	/*
