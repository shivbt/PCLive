...
enum sfd_type {
	...
	LOG_FD_OFF,
    IMG_ROOT_FD_OFF,    /* Shiv: Root directory of all images during iterative mig*/
	DATA_FIFO_PIPE_FD_OFF,	/* Shiv: Fifo pipe for pages data signaling during parallel restore*/
	FIFO_PIPE_FD_OFF,	/* Shiv: Fifo pipe for others signaling during parallel restore*/
	IMG_FD_OFF,
	IMG_PR_RST_FD_OFF,
	IMG_STREAMER_FD_OFF,
