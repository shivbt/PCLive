...
// Function to check whether a tunfile entry is already present from
// the previous iteration.
static int search_and_update_one_tunfile (ProtobufCMessage *base) {
    ...
    tfe = pb_msg (base, TunfileEntry);
    id = tfe->id;
    type = (&tunfile_desc_ops)->type;
...
struct collect_image_info tunfile_cinfo = {
    ...
    .search_and_update = search_and_update_one_tunfile,
