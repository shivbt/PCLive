...
static const ProtobufCFieldDescriptor sa_entry__field_descriptors[6] =
{
  {
    "sigaction",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT64,
    offsetof(SaEntry, has_mask_extended),
    offsetof(SaEntry, mask_extended),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
