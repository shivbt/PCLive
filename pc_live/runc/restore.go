...
using the runc checkpoint command.`,
	Flags: []cli.Flag{
        ...
        cli.BoolFlag{
            Name:  "no-prestore",
            Usage: "don't do pipelined restore",
        },
        cli.IntFlag{
            Name:  "iterations",
            Usage: "no of iterations used in iterative dumps",
        },
        cli.IntFlag{
            Name:  "rp",
            Usage: "point (or iteration) from where the pipelined restore starts",
        },
        cli.BoolFlag{
            Name:  "use-mmap",
            Usage: "read pages image files using mmap and memcpy",
        },
		cli.StringFlag{
