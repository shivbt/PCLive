...
struct parasite_ctl {
    ...
    unsigned long dain_fds_arg_size;        // Added by Shiv
    unsigned long posix_timers_arg_size;    // Added by Shiv
    unsigned long dump_pages_arg_size;      // Added by Shiv
    unsigned long aio_rings_arg_size;       // Added by Shiv
    unsigned long cgroup_arg_size;          // Added by Shiv
    unsigned long thread_arg_size;          // Added by Shiv
    unsigned long sigacts_arg_size;         // Added by Shiv
    unsigned long itimers_arg_size;         // Added by Shiv
    unsigned long misc_arg_size;            // Added by Shiv
    unsigned long tty_arg_size;             // Added by Shiv
    unsigned long args_offset;              // Added by Shiv
