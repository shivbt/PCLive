...
// Added by Shiv to support multiple dump regions inside parasite.
enum {
    PARASITE_REGION_MIN,
    PARASITE_DRAIN_FDS_ARGS_REGION,
    PARASITE_POSIX_TIMERS_ARGS_REGION,
    PARASITE_DUMP_PAGES_ARGS_REGION,
    PARASITE_AIO_RINGS_ARGS_REGION,
    PARASITE_DUMP_CGROUP_ARGS_REGION,
    PARASITE_DUMP_THREAD_ARGS_REGION,
    PARASITE_DUMP_SIGACTS_ARGS_REGION,
    PARASITE_DUMP_ITIMERS_ARGS_REGION,
    PARASITE_DUMP_MISC_ARGS_REGION,
    PARASITE_DUMP_TTY_ARGS_REGION,
    PARASITE_REGION_MAX
};
...
extern void *compel_parasite_args_s (struct parasite_ctl *ctl, int region_type);
