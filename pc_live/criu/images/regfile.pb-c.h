...
struct  _RegFileEntry
{
   ...
   */
  protobuf_c_boolean has_checksum_config;
   ...
   */
  protobuf_c_boolean has_checksum_parameter;
  uint32_t checksum_parameter;
};
#define REG_FILE_ENTRY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&reg_file_entry__descriptor) \
    , 0, 0, 0, NULL, NULL, 0,-1, 0,0, 0,0, 0,0, 0,NULL, 0,0, 0,0, 0,0 }
