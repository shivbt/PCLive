...
void   criu_xfer_server_info__init
                     (CriuXferServerInfo         *message)
{
  static CriuXferServerInfo init_value = CRIU_XFER_SERVER_INFO__INIT;
  *message = init_value;
}
size_t criu_xfer_server_info__get_packed_size
                     (const CriuXferServerInfo *message)
{
  assert(message->base.descriptor == &criu_xfer_server_info__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
size_t criu_xfer_server_info__pack
                     (const CriuXferServerInfo *message,
                      uint8_t       *out)
{
  assert(message->base.descriptor == &criu_xfer_server_info__descriptor);
...
size_t criu_xfer_server_info__pack_to_buffer
                     (const CriuXferServerInfo *message,
                      ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &criu_xfer_server_info__descriptor);
...
CriuXferServerInfo *
       criu_xfer_server_info__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data)
{
  return (CriuXferServerInfo *)
     protobuf_c_message_unpack (&criu_xfer_server_info__descriptor,
                                allocator, len, data);
}
void   criu_xfer_server_info__free_unpacked
                     (CriuXferServerInfo *message,
                      ProtobufCAllocator *allocator)
{
  assert(message->base.descriptor == &criu_xfer_server_info__descriptor);
...
void   criu_migrate_resp__init
                     (CriuMigrateResp         *message)
{
  static CriuMigrateResp init_value = CRIU_MIGRATE_RESP__INIT;
  *message = init_value;
}
size_t criu_migrate_resp__get_packed_size
                     (const CriuMigrateResp *message)
{
  assert(message->base.descriptor == &criu_migrate_resp__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
size_t criu_migrate_resp__pack
                     (const CriuMigrateResp *message,
                      uint8_t       *out)
{
  assert(message->base.descriptor == &criu_migrate_resp__descriptor);
...
size_t criu_migrate_resp__pack_to_buffer
                     (const CriuMigrateResp *message,
                      ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &criu_migrate_resp__descriptor);
...
CriuMigrateResp *
       criu_migrate_resp__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data)
{
  return (CriuMigrateResp *)
     protobuf_c_message_unpack (&criu_migrate_resp__descriptor,
                                allocator, len, data);
}
void   criu_migrate_resp__free_unpacked
                     (CriuMigrateResp *message,
                      ProtobufCAllocator *allocator)
{
  assert(message->base.descriptor == &criu_migrate_resp__descriptor);
...
static const ProtobufCFieldDescriptor criu_xfer_server_info__field_descriptors[4] =
{
  {
    "address",
    1,
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CriuXferServerInfo, address),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(CriuXferServerInfo, has_port),
    offsetof(CriuXferServerInfo, port),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(CriuXferServerInfo, has_pid),
    offsetof(CriuXferServerInfo, pid),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(CriuXferServerInfo, has_fd),
    offsetof(CriuXferServerInfo, fd),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned criu_xfer_server_info__field_indices_by_name[] = {
  0,   /* field[0] = address */
  3,   /* field[3] = fd */
  2,   /* field[2] = pid */
  1,   /* field[1] = port */
};
static const ProtobufCIntRange criu_xfer_server_info__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 4 }
};
const ProtobufCMessageDescriptor criu_xfer_server_info__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "criu_xfer_server_info",
  "CriuXferServerInfo",
  "CriuXferServerInfo",
  "",
  sizeof(CriuXferServerInfo),
  4,
  criu_xfer_server_info__field_descriptors,
  criu_xfer_server_info__field_indices_by_name,
  1,  criu_xfer_server_info__number_ranges,
  (ProtobufCMessageInit) criu_xfer_server_info__init,
  NULL,NULL,NULL    /* reserved[123] */
};
...
static const CriuNetworkLockMethod criu_opts__network_lock__default_value = CRIU_NETWORK_LOCK_METHOD__IPTABLES;
static const ProtobufCFieldDescriptor criu_opts__field_descriptors[69] =
{
  {
    "images_dir_fd",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(CriuOpts, has_pidfd_store_sk),
    offsetof(CriuOpts, pidfd_store_sk),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CriuOpts, lsm_mount_context),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_ENUM,
    offsetof(CriuOpts, has_network_lock),
    offsetof(CriuOpts, network_lock),
    &criu_network_lock_method__descriptor,
    &criu_opts__network_lock__default_value,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BOOL,
    offsetof(CriuOpts, has_no_prestore),
    offsetof(CriuOpts, no_prestore),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    offsetof(CriuOpts, xfer),
    &criu_xfer_server_info__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_STRING,
    offsetof(CriuOpts, n_dump_info),
    offsetof(CriuOpts, dump_info),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(CriuOpts, has_iterations),
    offsetof(CriuOpts, iterations),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(CriuOpts, has_rp),
    offsetof(CriuOpts, rp),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BOOL,
    offsetof(CriuOpts, has_use_mmap),
    offsetof(CriuOpts, use_mmap),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned criu_opts__field_indices_by_name[] = {
  ...
  68,   /* field[68] = use_mmap */
  18,   /* field[18] = veths */
  45,   /* field[45] = weak_sysctls */
  16,   /* field[16] = work_dir_fd */
  64,   /* field[64] = xfer */
};
static const ProtobufCIntRange criu_opts__number_ranges[3 + 1] =
{
  { 1, 0 },
  { 41, 39 },
  { 70, 63 },
...
static const ProtobufCFieldDescriptor criu_migrate_resp__field_descriptors[1] =
{
  {
    "migrated",
    1,
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BOOL,
    offsetof(CriuMigrateResp, has_migrated),
    offsetof(CriuMigrateResp, migrated),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned criu_migrate_resp__field_indices_by_name[] = {
  0,   /* field[0] = migrated */
};
static const ProtobufCIntRange criu_migrate_resp__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 1 }
};
const ProtobufCMessageDescriptor criu_migrate_resp__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "criu_migrate_resp",
  "CriuMigrateResp",
  "CriuMigrateResp",
  "",
  sizeof(CriuMigrateResp),
  1,
  criu_migrate_resp__field_descriptors,
  criu_migrate_resp__field_indices_by_name,
  1,  criu_migrate_resp__number_ranges,
  (ProtobufCMessageInit) criu_migrate_resp__init,
  NULL,NULL,NULL    /* reserved[123] */
};
...
static const ProtobufCFieldDescriptor criu_features__field_descriptors[3] =
{
  {
    "mem_track",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BOOL,
    offsetof(CriuFeatures, has_pidfd_store),
    offsetof(CriuFeatures, pidfd_store),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor criu_resp__field_descriptors[13] =
{
  {
    "type",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    offsetof(CriuResp, migrate),
    &criu_migrate_resp__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
...
static const ProtobufCEnumValue criu_network_lock_method__enum_values_by_number[2] =
{
  { "IPTABLES", "CRIU_NETWORK_LOCK_METHOD__IPTABLES", 1 },
  { "NFTABLES", "CRIU_NETWORK_LOCK_METHOD__NFTABLES", 2 },
};
static const ProtobufCIntRange criu_network_lock_method__value_ranges[] = {
{1, 0},{0, 2}
};
static const ProtobufCEnumValueIndex criu_network_lock_method__enum_values_by_name[2] =
{
  { "IPTABLES", 0 },
  { "NFTABLES", 1 },
};
const ProtobufCEnumDescriptor criu_network_lock_method__descriptor =
{
  PROTOBUF_C__ENUM_DESCRIPTOR_MAGIC,
  ...
  "",
  2,
  criu_network_lock_method__enum_values_by_number,
  2,
  criu_network_lock_method__enum_values_by_name,
  1,
  criu_network_lock_method__value_ranges,
  NULL,NULL,NULL,NULL   /* reserved[1234] */
};
...
static const ProtobufCEnumValue criu_req_type__enum_values_by_number[15] =
{
  ...
  { "MIGRATE", "CRIU_REQ_TYPE__MIGRATE", 13 },
  { "XFER_SERVER", "CRIU_REQ_TYPE__XFER_SERVER", 14 },
};
static const ProtobufCIntRange criu_req_type__value_ranges[] = {
{0, 0},{0, 15}
};
static const ProtobufCEnumValueIndex criu_req_type__enum_values_by_name[15] =
{
  { "CHECK", 3 },
  { "CPUINFO_CHECK", 8 },
  { "CPUINFO_DUMP", 7 },
