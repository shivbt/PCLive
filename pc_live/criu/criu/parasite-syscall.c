 ...
 * XXX: Shiv
 *
 * Modified to store all data in non-overlapping manner for pre-dump only.
 * For dump, I am following same old strategy.
 *
 */
void parasite_ensure_args_size (unsigned long sz, bool dump) {
...
struct parasite_ctl *parasite_infect_seized (pid_t pid, struct pstree_item *item
        , struct vm_area_list *vma_area_list, bool dump) {
	...
	parasite_ensure_args_size (dump_pages_args_size (vma_area_list), dump);
	parasite_ensure_args_size (aio_rings_args_size (vma_area_list), dump);
    ...
    //
	parasite_ensure_args_size (dump_cgroup_args_size (), dump);
	parasite_ensure_args_size (dump_threads_args_size (), dump);
	parasite_ensure_args_size (dump_sigacts_args_size (), dump);
	parasite_ensure_args_size (dump_itimers_args_size (), dump);
	parasite_ensure_args_size (dump_misc_args_size (), dump);
	parasite_ensure_args_size (dump_tty_args_size (), dump);
    // END
