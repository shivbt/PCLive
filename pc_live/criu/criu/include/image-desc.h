...
enum {
    ...
    // These values are used to transfer dump files using xfer-server.
    // Removed this value from protobuf enum "PB_"
    CR_FD_XF_REQ_DESCRIPTORS_JSON,
    CR_FD_XF_REQ_DINFO_BITMAP,
    CR_FD_XF_REQ_IOV_PARENT,
    CR_FD_XF_REQ_PAGEMAP_AND_PAGES,
    CR_FD_XF_REQ_NO_FILE
