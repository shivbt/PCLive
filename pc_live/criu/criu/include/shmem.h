...
extern int restore_sysv_shmem_content(struct vma_area *vma, void *addr, unsigned long size, unsigned long shmid);
extern int restore_memfd_shmem_content(struct vma_area *vma, int fd, unsigned long shmid, unsigned long size);
