...
extern int do_pb_read_one(struct cr_img *, void **objp, int type, bool global_info, bool eof);

#define pb_read_one(fd, objp, type)	do_pb_read_one(fd, (void **)objp, type, false, false)
#define pb_read_one_eof(fd, objp, type, global_info) do_pb_read_one(fd, (void **)objp, type, global_info, true)

extern int pb_write_one_buf (struct cr_img *img, void *obj, int type, void *pbuf, u32 size);
#define pb_write_one(img, obj, type) pb_write_one_buf((img), ((void *)obj), (type), (NULL), (0))
...
struct collect_image_info {
    ...
    int (*search_and_update) (ProtobufCMessage *);
