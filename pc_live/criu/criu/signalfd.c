...
// Function to check whether a signal fd entry is already present from
// the previous iteration.
static int search_and_update_one_sigfd (ProtobufCMessage *base) {
    ...
    sfe = pb_msg (base, SignalfdEntry);
    id = sfe->id;
    type = (&signalfd_desc_ops)->type;
...
struct collect_image_info signalfd_cinfo = {
    ...
    .search_and_update = search_and_update_one_sigfd,
